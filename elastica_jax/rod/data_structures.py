...
# jit is wrapped in symplectic_steppers.py
def overload_operator_kinematic_numba(
    ...
    method
    """
    position_collection = position_collection[:3, :n_nodes] + prefac * velocity_collection[:3, :n_nodes]
...
def overload_operator_dynamic_numba(rate_collection, scaled_second_deriv_array):
    ...
    rate_collection = jax.lax.add(rate_collection[:2, :blocksize], scaled_second_deriv_array[:2, :blocksize])
