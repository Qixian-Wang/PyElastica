...
overload_operator_kinematic_numba = jax.jit(overload_operator_kinematic_numba, static_argnums=(0,))
"""
Developer Note
--------------
...
class PositionVerlet:
    ...
    def _first_kinematic_step(self, System, time: np.float64, dt: np.float64):
        ...
        # print(System.n_nodes)
        update_position, update_director = overload_operator_kinematic_numba(
            System.n_nodes,
            prefac,
        ...
        System.kinematic_states.position_collection[:] = update_position
        System.kinematic_states.director_collection[:] = update_director

    def _first_dynamic_step(self, System, time: np.float64, dt: np.float64):

        updated_rates = overload_operator_dynamic_numba(
            System.dynamic_states.rate_collection,
            System.dynamic_rates(time, dt),
        )

        System.dynamic_states.rate_collection[:] = updated_rates
